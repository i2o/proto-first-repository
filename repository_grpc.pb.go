...
func (c *firstServiceClient) First(ctx context.Context, in *FirstRequest, opts ...grpc.CallOption) (*FirstResponse, error) {
	out := new(FirstResponse)
	err := c.cc.Invoke(ctx, "/FirstService/First", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFirstServiceServer) First(context.Context, *FirstRequest) (*FirstResponse, error) {
...
func _FirstService_First_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FirstRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FirstServiceServer).First(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/FirstService/First",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FirstServiceServer).First(ctx, req.(*FirstRequest))
	}
...
var FirstService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "First",
			Handler:    _FirstService_First_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto-first-repo/repository.proto",
}
